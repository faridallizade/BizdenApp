...
function GalleryShareManager({ event }: { event: EventItem }) {
  ...
  // Superseded by the multi-gallery manager; retained temporarily until this legacy file is fully split.
  if (window.location.pathname !== '/__legacy-gallery-share') return null
